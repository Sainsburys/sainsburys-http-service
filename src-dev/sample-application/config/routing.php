...
return [
    'routes' => [
        'simple-route' => [
            'http-verb'             => 'GET',
            'path'                  => '/person/{id}',
            'controller-service-id' => 'sainsburys.sainsburys-http-service.dev.sample-controller',
        ...
        'route-with-generic-error' => [
            ...
            'controller-service-id' => 'sainsburys.sainsburys-http-service.dev.controller-with-errors',
